...
// HTTP behaviour is covered in trivia_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "trivia://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("trivia", "about")
	if err != nil || got.String() != "trivia://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want trivia://page/about", got.String(), err)
	}
}
