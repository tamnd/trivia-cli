...
Most of these come down to network reality or how trivia serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

trivia rate-limits like any public site. trivia already paces
...
Where a surface is gated, trivia reads a cookie or token you supply
...
`trivia`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what trivia actually did
